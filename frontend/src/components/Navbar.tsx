...
const Navbar: React.FC = () => {
  ...
  const [islogoutModalOpen, setlogoutIsModalOpen] = useState<boolean>(false);
            ...
            <div className="flex-shrink-0 relative flex items-center" ref={userMenuRef}>
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-50">
                  <Link className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition duration-300" to={'/update'}>
                    Profile
                  </Link>
                  <button
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition duration-300 w-full text-left"
