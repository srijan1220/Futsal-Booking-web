...
import { getSingleNotificationAPI, updateNotitificationAPI } from '../../apis/api'
...
const EditNotification = () => {
    ...
    const handleSubmit= (e)=>{
        ...
        updateNotitificationAPI(id, formData).then((res)=>{
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal">
            ...
            <div className="relative top-20 mx-auto p-5 border w-1/2 shadow-lg rounded-md bg-white">
                               <form className="space-y-6">
                                    <h3 className="text-lg font-medium leading-6 text-gray-900 text-center font-semibold text-2xl">Edit Notification for {title}</h3>
